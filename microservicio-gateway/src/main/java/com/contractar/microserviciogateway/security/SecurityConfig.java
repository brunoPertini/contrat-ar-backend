...
public class SecurityConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/actuator/**", "/error").permitAll()
				...
				.antMatchers(productosUrls).hasAuthority(proveedorProductoRole)
				.antMatchers(HttpMethod.POST, servicesUrls).hasAuthority(proveedorProductoRole)
				.antMatchers(HttpMethod.POST, servicesUrls).hasAuthority(proveedorServicioRole)
